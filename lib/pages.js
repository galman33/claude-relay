function pinPageHtml(appName) {
  var name = escapeHtml(appName || "Claude Relay");
...
function setupPageHtml(httpsUrl, httpUrl, hasCert, lanMode, appName) {
  var name = appName || "Claude Relay";
  return `<!DOCTYPE html><html lang="en"><head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover">
<meta name="apple-mobile-web-app-capable" content="yes">
...
<div class="step-card" id="step-tailscale">
  ...
  <div class="step-desc">Tailscale creates a private VPN so you can access ${escapeHtml(name)} from anywhere. It needs to be installed on <b>both</b> the server (the machine running ${escapeHtml(name)}) and this device.</div>

  <div class="instruction"><div class="inst-num">1</div>
    <div class="inst-text"><b>Server:</b> Install Tailscale on the machine running ${escapeHtml(name)}.
...
<div class="step-card" id="step-pwa">
  ...
  <div class="step-desc">Install ${escapeHtml(name)} as an app for quick access and a full-screen experience.</div>
  ...
  <div class="platform-desktop">
    ...
    <div class="instruction"><div class="inst-num">2</div>
      <div class="inst-text">Click it and then click <b>Install</b> to confirm.
        <div class="note">If there is no icon, go to <b>Menu > Install ${escapeHtml(name)}</b> or <b>Menu > Save and Share > Install</b>.</div>
      </div>
    </div>
  </div>

  <div id="pwa-status" class="check-status pending">After installing, open ${escapeHtml(name)} from your home screen to continue setup.</div>
...
<div class="step-card" id="step-done">
  <div class="done-card">
    ...
    <a class="btn" id="done-link" href="${httpsUrl}">Open ${escapeHtml(name)}</a>
  </div>
</div>
</div>
...
function pushDone() {
  ...
  navigator.serviceWorker.ready.then(function(reg) {
    reg.showNotification("\ud83c\udf89 Welcome to ${escapeHtml(name)}!", {
...
function dashboardPageHtml(projects, version, appName) {
  var dashName = escapeHtml(appName || "Claude Relay");
  var cards = "";
