...
function createProjectContext(opts) {
  ...
  function handleConnection(ws) {
    ...
    // Send cached state
    sendTo(ws, { type: "info", cwd: cwd, slug: slug, project: title || project, version: currentVersion, debug: !!debug, dangerouslySkipPermissions: dangerouslySkipPermissions, lanHost: lanHost, appName: appName, projectCount: getProjectCount(), projects: getProjectList() });
    if (latestVersion) {
  ...
  function handleMessage(ws, msg) {
    ...
    if (msg.type === "set_app_name") {
      if (opts.onSetAppName) opts.onSetAppName(msg.appName || null);
      return;
    }
  ...
  function setTitle(newTitle) {
    title = newTitle || null;
    send({ type: "info", cwd: cwd, slug: slug, project: title || project, version: currentVersion, debug: !!debug, lanHost: lanHost, appName: appName, projectCount: getProjectCount(), projects: getProjectList() });
  }
