...
var cachedAppName = "Claude Relay";

export function updatePageTitle(appNameOverride) {
  if (appNameOverride) cachedAppName = appNameOverride;
  var sessionTitle = "";
  ...
  if (ctx.projectName && sessionTitle) {
    ...
    document.title = ctx.projectName + " - " + cachedAppName;
  } else {
